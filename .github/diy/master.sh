...
git clone --depth 1 https://github.com/kenzok8/wall && mv -n wall/UnblockNeteaseMusic wall/gost wall/smartdns wall/adguardhome wall/filebrowser wall/lua-neturl wall/naiveproxy wall/sagernet-core wall/tcping wall/redsocks2  wall/microsocks ./ ; rm -rf wall
