...
git clone --depth 1 https://github.com/immortalwrt/luci && mv -n luci/applications/luci/applications/luci-app-gost luci/applications/luci-app-dockerman luci/applications/luci-app-filebrowser ./ ; rm -rf luci
