...
git clone --depth 1 https://github.com/QiuSimons/openwrt-mos && openwrt-mos/luci-app-mosdns ./ ; rm -rf openwrt-mos
...
git clone --depth 1 https://github.com/kenzok8/wall && mv -n wall/gost wall/smartdns wall/adguardhome wall/filebrowser wall/mosdns wall/lua-neturl wall/sagernet-core wall/tcping wall/redsocks2  wall/microsocks ./ ; rm -rf wall
